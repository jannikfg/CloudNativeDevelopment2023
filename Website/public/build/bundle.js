...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$7, 12, 4, 201);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$5 = "src/Rides/RideItem.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	let button2;
    	let current;
    	let if_block = /*isFav*/ ctx[8] && create_if_block$2(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 20, 8, 437);
    			attr_dev(header, "class", "svelte-1mo1dn5");
    			add_location(header, file$5, 19, 4, 420);
    			attr_dev(p0, "class", "svelte-1mo1dn5");
    			add_location(p0, file$5, 28, 8, 630);
    			attr_dev(p1, "class", "svelte-1mo1dn5");
    			add_location(p1, file$5, 29, 8, 654);
    			attr_dev(div, "class", "content svelte-1mo1dn5");
    			add_location(div, file$5, 27, 4, 600);
    			attr_dev(footer, "class", "svelte-1mo1dn5");
    			add_location(footer, file$5, 31, 4, 690);
    			attr_dev(article, "class", "svelte-1mo1dn5");
    			add_location(article, file$5, 18, 0, 406);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/Rides/RideGrid.svelte";
    ...
    class RideGrid extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { rides: 0 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 14, 8, 346);
    		},
    		m: function mount(target, anchor) {
    ...
    const file$1 = "src/Rides/EditRide.svelte";
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 35, 4, 782);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 93, 4, 2229);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	editride.$on("save", /*addRide*/ ctx[2]);
    ...
    function create_fragment(ctx) {
    	...
    	ridegrid = new RideGrid({
    			props: { rides: /*rides*/ ctx[0] },
    			$$inline: true
    		});

    	ridegrid.$on("togglefavorite", /*togglefavorite*/ ctx[3]);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 73, 4, 2000);
    			attr_dev(main, "class", "svelte-15n0udb");
    			add_location(main, file, 72, 0, 1989);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*rides*/ 1) ridegrid_changes.rides = /*rides*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function addRide(event) {
    		...
    		$$invalidate(0, rides = [...rides, newRide]);
    	...
    	function togglefavorite(event) {
    		...
    		$$invalidate(0, rides = updatedRides);
    	}
    	...
    	return [rides, editMode, addRide, togglefavorite, click_handler];
    }
