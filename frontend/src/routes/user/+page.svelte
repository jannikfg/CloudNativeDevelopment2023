...
<div class="profile">
  ...
  <form
    ...
    action="{PUBLIC_IMAGESERVICE_URL}/{user?.email}"
  ...
  <table class="profile_table">
    <tr>
      ...
      <td class="profile_table_value">{user?.firstName}</td>
    </tr>
    <tr>
      <td class="profile_table_label">Last Name:</td>
      <td class="profile_table_value">{user?.lastName}</td>
    </tr>
    <tr>
      <td class="profile_table_label">E-Mail:</td>
      <td class="profile_table_value">{user?.email}</td>
    </tr>
    <tr>
      <td class="profile_table_label">Birthdate:</td>
      <td class="profile_table_value">{user?.birthDate}</td>
    </tr>
  </table>
</div>
